import{a as h,S as g,i as b}from"./assets/vendor-b0d10f48.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function a(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(t){if(t.ep)return;t.ep=!0;const r=a(t);fetch(t.href,r)}})();const L="43559338-49e51b38628b18648a05e4f59",w="https://pixabay.com/api/",u=async(e,o)=>(await h.get(w,{params:{key:L,q:e,image_type:"photo",orientation:"horizontal",safesearch:!0,page:o,per_page:15}})).data;let S=new g(".gallery a");const y=e=>{const o=document.querySelector(".gallery"),a=e.map(s=>`
  ...
  `).join("");o.insertAdjacentHTML("beforeend",a),S.refresh()},q=()=>{const e=document.querySelector(".gallery");e.innerHTML=""},c=e=>{b.info({title:"",message:e,position:"topRight"})},v=()=>{const e=document.querySelector(".load-more");e.style.display="block"},f=()=>{const e=document.querySelector(".load-more");e.style.display="none"},M=document.getElementById("search-form"),P=document.querySelector(".load-more"),m=document.querySelector(".loader");let i="",n=1;M.addEventListener("submit",B);P.addEventListener("click",$);async function B(e){if(e.preventDefault(),i=e.currentTarget.searchQuery.value.trim(),i===""){c("Please enter a search query.");return}n=1,q(),f();try{p();const o=await u(i,n);l(),o.hits.length===0?error("Sorry, there are no images matching your search query. Please try again!"):(y(o.hits),o.totalHits>15&&v())}catch(o){l(),console.error(o),c("Something went wrong. Please try again.")}}async function $(){n+=1;try{p();const e=await u(i,n);l(),y(e.hits),n*15>=e.totalHits&&(f(),c("We're sorry, but you've reached the end of search results."))}catch(e){l(),console.error(e),c("Something went wrong. Please try again.")}}function p(){m.style.display="block"}function l(){m.style.display="none"}
